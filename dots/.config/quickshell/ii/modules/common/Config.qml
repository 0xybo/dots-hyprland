    ...
    FileView {
        ...
        JsonAdapter {
            ...
            property JsonObject bar: JsonObject {
                ...
                property string topLeftIcon: "spark" // Options: "distro", any icon name in ~/.config/quickshell/ii/assets/icons or "none"
            ...
            property JsonObject sidebar: JsonObject {
                ...
                property bool keepSidebarSecondaryLoaded: true
                property JsonObject translator: JsonObject {
                    property bool enable: false
